...
struct StoryBrain{
    ...
    func getChoicesOne() -> String{
        return story[storyNumber].ch1
    }
    func getChoicesTwo() -> String{
        return story[storyNumber].ch2
    }
    
    mutating func nextStory(UserChoice: String) {
        let currentStory = story[storyNumber]
        if UserChoice == currentStory.ch1 {
            storyNumber = currentStory.ch1Dest
        }else if UserChoice == story[storyNumber].ch2{
            storyNumber = currentStory.ch2Dest
          }
     }
}
