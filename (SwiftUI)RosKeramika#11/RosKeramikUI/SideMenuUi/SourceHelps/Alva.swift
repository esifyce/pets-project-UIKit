        ...
        VStack{
            ScrollView{
                ...
                VStack(alignment: .leading, spacing: 3){
                    Text("Alva").fontWeight(.bold).padding(.bottom,20).padding(.top, 10)
                    Image("SkidkiAlva3-4").resizable().frame(width: 350, height: 400)
                    HStack{
                        Text("Цена:")
                        Spacer()
                        Text("767 сомов").fontWeight(.bold)
                    }
                    HStack{
