        ...
        VStack{
            ScrollView{
                ...
                VStack(alignment: .leading, spacing: 3){
                    Text("Wood").fontWeight(.bold).padding(.bottom,20).padding(.top, 10)
                    Image("wood").resizable().frame(width: 350, height: 400)
                    HStack{
                        Text("Цена:")
                        Spacer()
                        Text("447 сомов").fontWeight(.bold)
                    }
                    HStack{
