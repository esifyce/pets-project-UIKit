        ...
        VStack{
            ScrollView{
                ...
                VStack(alignment: .leading, spacing: 3){
                    Text("Torres").fontWeight(.bold).padding(.bottom,20).padding(.top, 10)
                    Image("SkidkiTorres1-4").resizable().frame(width: 350, height: 400)
                    HStack{
                        Text("Цена:")
                        Spacer()
                        Text("667 сомов").fontWeight(.bold)
                    }
                    HStack{
