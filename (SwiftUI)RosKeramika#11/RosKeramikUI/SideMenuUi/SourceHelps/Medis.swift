        ...
        VStack{
            ScrollView{
                ...
                VStack(alignment: .leading, spacing: 3){
                    Text("Medis").fontWeight(.bold).padding(.bottom,20).padding(.top, 10)
                    Image("SkidkiMedis4-4").resizable().frame(width: 350, height: 400)
                    HStack{
                        Text("Цена:")
                        Spacer()
                        Text("467 сомов").fontWeight(.bold)
                    }
                    HStack{
