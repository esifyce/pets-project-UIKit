        ...
        VStack{
            ScrollView{
                ...
                VStack(alignment: .leading, spacing: 3){
                    Text("Cassana").fontWeight(.bold).padding(.bottom,20).padding(.top, 10)
                    Image("cassana").resizable().frame(width: 350, height: 400)
                    HStack{
                        Text("Цена:")
                        Spacer()
                        Text("647 сомов").fontWeight(.bold)
                    }
                    HStack{
