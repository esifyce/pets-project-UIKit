        ...
        VStack{
            ScrollView{
                ...
                VStack(alignment: .leading, spacing: 3){
                    Text("Piastra Pearl").fontWeight(.bold).padding(.bottom,20).padding(.top, 10)
                    Image("piastra").resizable().frame(width: 350, height: 400)
                    HStack{
                        Text("Цена:")
                        Spacer()
                        Text("747 сомов").fontWeight(.bold)
                    }
                    HStack{
