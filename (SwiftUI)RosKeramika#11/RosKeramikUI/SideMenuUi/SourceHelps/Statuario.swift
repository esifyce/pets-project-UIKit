...
struct Statuario: View {
    var body: some View {
        StatuarioDetail()
    }
}
struct StatuarioDetail: View{
        ...
        VStack{
            ScrollView{
                ...
                VStack(alignment: .leading, spacing: 3){
                    Text("Statuario").fontWeight(.bold).padding(.bottom,20).padding(.top, 10)
                    Image("statuario").resizable().frame(width: 350, height: 400)
                    HStack{
                        Text("Цена:")
                        Spacer()
                        Text("547 сомов").fontWeight(.bold)
                    }
                    HStack{
