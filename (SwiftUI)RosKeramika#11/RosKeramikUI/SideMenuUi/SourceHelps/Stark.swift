        ...
        VStack{
            ScrollView{
                ...
                VStack(alignment: .leading, spacing: 3){
                    Text("Stark").fontWeight(.bold).padding(.bottom,20).padding(.top, 10)
                    Image("SkidkiStark2-4").resizable().frame(width: 350, height: 400)
                    HStack{
                        Text("Цена:")
                        Spacer()
                        Text("967 сомов").fontWeight(.bold)
                    }
                    HStack{
