...
let handbooks = [
    ...
    Course(title: "React Hooks Handbook", subtitle: "30 sections - 3 hours", description: "A comprehensive series of tutorials on REact Hooks and more!", icon: UIImage(named: "Logo React"), banner: UIImage(named: "Illustration 4"), colors: [
...
let courses = [
    ...
    Course(title: "Flutter for Designers", subtitle: "20 sections - 3 hours", description: "Build an Flutter app for iOS and Android with custom layouts, animations, and more", icon: UIImage(named: "Logo Flutter"), banner: UIImage(named: "Illustration 1"), authors: ["Sai Kambampati"], background: UIImage(named: "Background 4"), sections: sections),
    Course(title: "React Hooks Handbook", subtitle: "20 sections - 3 hours", description: "A comprehensive series of tutorials on React Hooks and more!", icon: UIImage(named: "Logo React"), banner: UIImage(named: "Illustration 2"),authors: ["Meng To"], background: UIImage(named: "Background 5"), sections: sections)
]
